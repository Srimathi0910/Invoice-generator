...
const faqsData = [
  {
    ...
    answer:
      "To create a new invoice, go to the Dashboard, click 'New Invoice', fill out the details and click 'Save'.",
  },
  {
    question: "How can I track my payments?",
    answer:
      "Go to 'My Invoices' and check the status column to track your payments.",
  },
  {
    question: "How can I download?",
    answer:
      "You can download invoices as PDF by clicking the download button next to each invoice.",
  },
  {
    question: "How to pay the invoice bill?",
    answer: "Click 'Payments' in the menu and follow the payment instructions.",
  },
];
      ...
      <motion.div variants={itemVariant} className="max-w-3xl mx-auto">
        ...
        <div className="glass bg-white/20 p-6  p-6 sm:p-10 rounded-md">
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-12 justify-center items-center">
            {/* Email Card */}
            <div
              className="bg-white px-6 py-4 rounded-md w-full max-w-[320px] h-[100px]
      ...
      flex items-center gap-4"
            >
              ...
              <div>
                ...
                <p className="text-gray-600 break-all">support@invoice.com</p>
              </div>
            </div>
