            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card title="Company Profile">
                <div className="flex gap-4 mb-4 items-center">
                  ...
                  <input className="border px-3 py-2 w-full" placeholder="Company Name" value={formData.companyName} onChange={(e) => setFormData({ ...formData, companyName: e.target.value })} />
                </div>
              ...
              <Card title="Payment Settings">
                ...
                <select className="border px-3 py-2 w-full mb-4" value={formData.currency} onChange={(e) => setFormData({ ...formData, currency: e.target.value })}>
                  <option value="INR">Indian Rupee</option>
                  <option value="USD">USD</option>
                </select>

                <label className="block mb-1 font-medium">Default GST Rate</label>
                <select className="border px-3 py-2 w-full mb-4" value={formData.gstRate} onChange={(e) => setFormData({ ...formData, gstRate: Number(e.target.value) })}>
              ...
              <div className="md:col-span-2">
                <Card title="Bank Information">
                  ...
                  <input className="border px-3 py-2 w-full mb-4" placeholder="Bank Name" value={formData.bankName} onChange={(e) => setFormData({ ...formData, bankName: e.target.value })} />

                  <label className="block mb-1 font-medium">Account Number</label>
                  <input className="border px-3 py-2 w-full mb-4" placeholder="Account Number" value={formData.accountNumber} onChange={(e) => setFormData({ ...formData, accountNumber: e.target.value })} />
