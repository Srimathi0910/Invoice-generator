...
export default function ReportsPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariant}
        className="glass bg-white/20 rounded-lg p-4 md:p-6 shadow overflow-x-auto"
      >
        ...
        <div className="overflow-x-auto w-full">
          <table className="min-w-full  table-auto text-sm md:text-base min-w-full table-auto text-sm md:text-base">
            <thead className="bg-gray-100 glass bg-white/30 backdrop-blur">
              <tr className="hidden md:table-row hidden md:table-row border-t border-white/20">
                {" "}
